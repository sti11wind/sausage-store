...
sudo echo PSQL_HOST=${PSQL_HOST} > /home/jarservice/vars
sudo echo PSQL_PORT=${PSQL_PORT} >> /home/jarservice/vars
sudo echo PSQL_DBNAME=${PSQL_DBNAME} >> /home/jarservice/vars
sudo echo PSQL_USER=${PSQL_USER} >> /home/jarservice/vars
sudo echo PSQL_PASSWORD=${PSQL_PASSWORD} >> /home/jarservice/vars
sudo echo MONGO_USER=${MONGO_USER} >> /vars/jarservice/vars
